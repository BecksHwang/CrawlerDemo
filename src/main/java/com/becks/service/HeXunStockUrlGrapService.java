 ...
 */
@Component
public class HeXunStockUrlGrapService {
	static Logger logger = Logger.getLogger(HeXunStockUrlGrapService.class);
	@Autowired
	...
	public void grap() {
		...
		for (Target target : targetList) {
			if (target.getMissionId() == CommonParameter.HEXUN_URL) {
	...
	public class GrapThread extends Thread {
		...
		protected void performTarget(Target target) {
			...
			try {
				...
				String html = null;
				html = new GrapMethodUtil().getStringByUrlHeXun(urlstr);
